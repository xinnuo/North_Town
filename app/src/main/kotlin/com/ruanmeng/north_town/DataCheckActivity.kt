    ...
    override fun init_title() {
        ...
        mAdapter = SlimAdapter.create()
                .register<CommonData>(R.layout.item_check_list) { data, injector ->
                    injector.visibility(R.id.item_check_divider, if (list.indexOf(data) == 0) View.VISIBLE else View.GONE)
                            .clicked(R.id.item_check) { startActivity(DataProductActivity::class.java) }
                }
